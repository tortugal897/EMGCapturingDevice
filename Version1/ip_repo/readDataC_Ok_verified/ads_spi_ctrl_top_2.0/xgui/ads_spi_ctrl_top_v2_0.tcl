...
proc init_gui { IPINST } {
  ...
  #Adding Group
  set SPI_Configuration [ipgui::add_group $IPINST -name "SPI Configuration" -parent ${Page_0}]
  ipgui::add_param $IPINST -name "ADS_SPI_CLK_FREQ" -parent ${SPI_Configuration}
  ipgui::add_param $IPINST -name "ADS_SPI_SCLK_FREQ" -parent ${SPI_Configuration}
  ipgui::add_param $IPINST -name "ADS_SPI_FRAME_N" -parent ${SPI_Configuration}
  ipgui::add_param $IPINST -name "ADS_SPI_BIT_N" -parent ${SPI_Configuration}
