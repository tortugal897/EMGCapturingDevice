...
proc create_ipi_design { offsetfile design_name } {
	...
	set not_irq_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:not_irq:1.0 not_irq_0 ]
	...
	# Connect all clock & reset of not_irq_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins not_irq_0/in_irq]
	connect_bd_net [get_bd_pins not_irq_0/in_irq_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins not_irq_0/in_irq_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of not_irq_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins not_irq_0/not_irq]
	connect_bd_net [get_bd_pins not_irq_0/not_irq_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins not_irq_0/not_irq_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins not_irq_0/not_irq_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins not_irq_0/not_irq_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins not_irq_0/not_irq_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of not_irq_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {not_irq_0/not_irq/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_not_irq_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells not_irq_0]

	# Copy all address to not_irq_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/not_irq_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_not_irq_0_in_irq_* ]]
	puts $fp "set in_irq_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:not_irq:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/not_irq_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "not_irq_v1_0_hw_${i}"
