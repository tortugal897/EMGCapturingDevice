...
HD_PWD='C:/Users/victo/Desktop/TFM/Zynq/TFM_ZINQ/TFM_ZINQ.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TFM_ZYNQ_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TFM_ZYNQ_wrapper.tcl
