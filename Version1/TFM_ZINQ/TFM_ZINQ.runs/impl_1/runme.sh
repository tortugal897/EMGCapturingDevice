...
HD_PWD='C:/Users/victo/Desktop/TFM/Zynq/TFM_ZINQ/TFM_ZINQ.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TFM_ZYNQ_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TFM_ZYNQ_wrapper.tcl -notrace
