...
################################################################
# This is a generated script based on design: TFM_ZYNQ
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ADS_DRY [ create_bd_port -dir I -type intr ADS_DRY ]
  ...
  connect_bd_net -net ADS_DRY_1 [get_bd_ports ADS_DRY] [get_bd_pins not_irq_0/in_irq]
  ...
  connect_bd_net -net axi_quad_spi_0_sck_o [get_bd_ports SPI_CLOCK] [get_bd_pins axi_quad_spi_0/sck_o]
  connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_ports SPI_CS] [get_bd_pins axi_quad_spi_0/ss_o]
  connect_bd_net -net not_irq_0_not_irq [get_bd_pins not_irq_0/not_irq] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
