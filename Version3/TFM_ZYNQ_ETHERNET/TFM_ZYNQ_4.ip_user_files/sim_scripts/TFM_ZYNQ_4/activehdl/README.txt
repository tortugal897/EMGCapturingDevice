...
#
# Generated by export_simulation on Tue May 30 19:59:28 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './TFM_ZYNQ_4.sh' script.

./TFM_ZYNQ_4.sh -reset_run
...
./TFM_ZYNQ_4.sh -noclean_files

For more information on the script, please type './TFM_ZYNQ_4.sh -help'.
