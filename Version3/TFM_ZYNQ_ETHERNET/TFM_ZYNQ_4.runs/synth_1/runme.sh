...
HD_PWD='C:/Users/victo/Desktop/TFM/Zynq/TFM_ZYNQ_ETHERNET/TFM_ZYNQ_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TFM_ZYNQ_4_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TFM_ZYNQ_4_wrapper.tcl
